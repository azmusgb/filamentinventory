(function(root, factory) {
  ...
  function normalizeSpool(input = {}, {owner = 'Bill', householdId = 'default-household'} = {}) {
    ...
    const printerName=placement.state==='Loaded'?(placement.printerId||safeText(input.printerName,60)):'';
    const feederName=placement.state==='Loaded'&&!placement.external?(placement.feederId||safeText(input.feederName,60)):'';
