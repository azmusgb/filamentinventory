(() => {
  ...
  function settingsMarkup() {
    return `<section class="panel ux-profile-head"><div><span class="eyebrow">Personal experience · v9</span><h2 id="preferencesTitle">Make the app fit the person and device.</h2><p class="muted">Preferences are stored locally per user profile. Bill and Aimee can use different layouts, themes, landing pages and defaults without changing shared inventory data.</p></div><label class="ux-profile-pill">Editing preferences for <select id="uxProfile" class="select"><option>Bill</option><option>Aimee</option></select></label></section>
