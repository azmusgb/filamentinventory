...
.live-deck{position:sticky;top:72px;z-index:32;display:flex;align-items:center;gap:8px;overflow-x:auto;padding:8px;margin:12px 0;border:1px solid rgba(57,87,100,.7);border-radius:15px;background:rgba(7,15,21,.9);backdrop-filter:blur(20px);box-shadow:0 13px 34px rgba(0,0,0,.24);scrollbar-width:none}.live-deck::-webkit-scrollbar{display:none}.deck-label{flex:0 0 auto;font-size:9px;font-weight:850;letter-spacing:.14em;text-transform:uppercase;color:var(--muted2);padding:0 5px}.deck-action{flex:0 0 auto;width:auto;min-height:36px;padding:8px 11px;border-radius:10px;font-size:10px}.deck-separator{width:1px;height:22px;background:#27424e;flex:0 0 auto}.live-progress{height:7px;border:1px solid #27414d;border-radius:999px;background:#061017;overflow:hidden;margin-top:12px}.live-progress>span{display:block;height:100%;width:0;border-radius:inherit;background:linear-gradient(90deg,var(--accent2),var(--accent));transition:width .45s ease}.progress-meta{display:flex;justify-content:space-between;gap:8px;margin-top:6px;font-size:9px;color:var(--muted2);font-variant-numeric:tabular-nums}.health-progress{grid-column:1/-1;width:100%;margin:-3px 0 4px}.signal{font-weight:760}.signal.excellent{color:var(--accent)}.signal.good{color:#b3e8ff}.signal.fair{color:var(--warn)}.signal.weak{color:var(--danger)}.sr-live{position:fixed;width:1px;height:1px;padding:0;margin:-1px;overflow:hidden;clip:rect(0,0,0,0);white-space:nowrap;border:0}.stale-data .live-dot{background:var(--warn);box-shadow:0 0 0 5px rgba(255,198,118,.08)}.stale-data .command-card{border-color:#39434a}.stale-data #lastRefresh{color:var(--warn)}.nav a[aria-current='true']{background:#142833;color:#f4fbfe;box-shadow:inset 0 0 0 1px #294b5a}.action-busy{opacity:.65;pointer-events:none}.deck-action[data-tone='danger']{background:linear-gradient(180deg,#4d1b23,#35151b);border-color:#823943}.deck-action[data-tone='blue']{background:linear-gradient(180deg,#153a50,#102b3d);border-color:#315e76}.deck-spacer{flex:1 0 12px}.deck-status{flex:0 0 auto;color:var(--muted);font-size:9px;font-weight:700;padding-right:4px}.command-card[data-active='true']{border-color:#315a6b;box-shadow:0 15px 40px rgba(0,0,0,.26),inset 0 0 0 1px rgba(115,201,255,.05)}
...
void WebDashboard::sendRoot() {
  ...
  s += F("<div class='appbar' id='home'><div class='brand'><div class='mark'>WH</div><div><span class='eyebrow'>LOCAL DEVICE OS</span><h1>Waveshare Home</h1></div></div><div class='status-cluster'><span id='localClock' class='clock'></span><span id='liveDot' class='live-dot'></span><span id='liveOnline' class='pill ");
  s += networkOnline ? "good'>ONLINE" : "bad'>OFFLINE";
  s += F("</span></div></div>");
  s += F("<nav class='nav' aria-label='Dashboard sections'><a href='#home'>Overview</a><a href='#now'>Now</a><a href='#attention'>Attention</a><a href='#wifi'>Network</a><a href='#device'>Experience</a><a href='#integrations'>Integrations</a><a href='#workshop'>Workshop</a><a href='#ota'>Updates</a><a href='#recovery'>Recovery</a><a class='json' href='/api/status'>JSON</a></nav>");

  s += F("<section class='hero'><div><span class='eyebrow'>LOCAL CONTROL PLANE</span><h2>Your workshop, printer and device — operational at a glance.</h2><p>A local-first command center that prioritizes what needs attention, keeps common controls one tap away, and exposes deep diagnostics only when you need them.</p><div class='hero-actions'><form method='post' action='/update/check' data-async='1'><button type='submit'>Check for update</button></form><form method='post' action='/wifi/reconnect' data-async='1'><button type='submit' class='muted'>Reconnect Wi-Fi</button></form><form method='post' action='/audio/test' data-async='1'><button type='submit' class='ghost'>Test speaker</button></form></div></div><div class='health'><div class='health-row'><span>Boot guard</span><strong id='liveBoot'>");
  ...
  s += F("<div class='card panel' id='wifi'><div class='section-head'><div><span class='eyebrow'>CONNECTIVITY</span><h2>Wi-Fi</h2></div><span class='section-chip'>LAN</span></div><p class='section-intro'>Connectivity, signal health and recovery controls for the local control plane.</p>");
