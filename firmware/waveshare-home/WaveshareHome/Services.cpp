...
void WebDashboard::sendRoot() {
  ...
  s += F("<div class='appbar' id='home'><div class='brand'><div class='mark'>WH</div><div><span class='eyebrow'>LOCAL DEVICE OS</span><h1>Waveshare Home</h1></div></div><div class='status-cluster'><span id='liveDot' class='live-dot'></span><span id='liveOnline' class='pill ");
  s += networkOnline ? "good'>ONLINE" : "bad'>OFFLINE";
  s += F("</span></div></div>");
  s += F("<nav class='nav' aria-label='Dashboard sections'><a href='#home'>Overview</a><a href='#now'>Now</a><a href='#wifi'>Network</a><a href='#device'>Experience</a><a href='#integrations'>Integrations</a><a href='#workshop'>Workshop</a><a href='#ota'>Updates</a><a href='#recovery'>Recovery</a><a class='json' href='/api/status'>JSON</a></nav>");
