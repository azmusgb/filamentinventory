...
export default async (req: Request) => {
  ...
  // Compatibility boundary for older clients that still send profile=. The
  // request remains validated, but profile is intentionally omitted from the
  // encoded QR target. A physical label resolves durable spool identity only.
