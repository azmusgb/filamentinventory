...
test('Netlify exposes only the six intended function modules', async () => {
  ...
  assert.deepEqual(entries, ['device-feed-v1.mts', 'display-feed.mts', 'inventory-assistant.mts', 'qr.mts', 'sync-admin.mts', 'sync.mts']);
});
